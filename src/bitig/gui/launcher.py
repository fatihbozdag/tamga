"""Launch the bitig desktop GUI — NiceGUI rendered in a PyWebView native window."""
...
def launch(
    *,
    ...
    try:
        ...
        raise ImportError(
            "bitig GUI requires the 'gui' extra. Install with: uv pip install 'bitig[gui]'"
        ) from exc
    ...
    from bitig.gui import app as _app  # noqa: F401
