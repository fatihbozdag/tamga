...
This page covers the clean subset of the ``tamga.forensic`` API that can be
...
from tamga.features import CharNgramExtractor, MFWExtractor
from tamga.forensic import GeneralImpostors, Unmasking, distort_corpus
        ...
        async def do_verify() -> None:
            ...
            try:
                ...
                if distortion_switch.value:
                    ...
                    from tamga.forensic import distort_text
