...
<p align="center">
  <img src="assets/tamga-banner.svg" alt="tamga — hesaplamalı stilometri" style="max-width: 100%;">
</p>
...
> Adını **tamga**dan alır — Türk boylarının bireyi ve aileyi tek bakışta tanımlayan
> damgasından, yani biçembilimsel parmak izinin kültürel karşılığından.

## Mimari

<p align="center">
  <img src="assets/tamga-architecture.svg" alt="derlem → öznitelikler → yöntemler → adli → çıktı" style="max-width: 100%;">
</p>
...
-   :fontawesome-solid-rocket:{ .lg .middle } **Başlarken**
    ...
    tamga'yı kurun, ilk derlemizi oluşturun ve CLI'dan bir Burrows Delta çalışması çalıştırın.
...
**5. aşama tamamlandı** — görselleştirme, Jinja2 raporları, bildirimsel çalıştırıcı (`tamga run`) ve
Rich tabanlı etkileşimli `tamga shell`.
...
**Çok dilli aşama tamamlandı** — `tamga.languages` kayıt defterinin arkasında İngilizce, Türkçe,
...
BSD-3-Clause. Bkz. [`LICENSE`](https://github.com/fatihbozdag/tamga/blob/main/LICENSE).

tamga'yı yayımlanmış bir çalışmada kullanıyorsanız lütfen
[`CITATION.cff`](https://github.com/fatihbozdag/tamga/blob/main/CITATION.cff) aracılığıyla atıf yapın.
